...
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/vdc_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a VDC address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/vdc_tooltip"), tr("&About VDC"), this);
    aboutAction->setToolTip(tr("Show information about VDC"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for VDC"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/vdc_tooltip"), tr("Show/Hide &VDC"), this);
    toggleHideAction->setToolTip(tr("Show or hide the VDC window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/vdc_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/vdc_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/vdc_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("VDC client"));
    trayIcon->setIcon(QIcon(":/icons/vdc_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VDC network", "", count));
}
