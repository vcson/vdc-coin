...
// Copyright (c) 2014 The VDC developers
...
// for both peerunityd and vdc(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of VDC releases, the client name should be selected from
...
#ifdef GIT_ARCHIVE
#    define GIT_COMMIT_ID "Join"
#    define GIT_COMMIT_DATE __DATE__ ", " __TIME__
#endif
